    ...
    >
          ...
          <div className="brand-section">
            ...
            >
              <div className="logo-icon">
                <div className="ir-logo"><span className="ir-text">IR</span></div>
              </div>
        ...
        <div className="db-banner-inner">
          ...
          <div className="db-stats-chips">
            <div className="db-stat-chip">
              <div className="db-stat-chip-value">{resumes.length}</div>
      ...
      <div className="db-main">
        <div className="db-body-grid">
          ...
          {/* ── Left Column (Main Actions & Resumes) ── */}
          ...
          <div className="db-sidebar">
            <div className="db-sidebar-card">
              <div className="db-sidebar-title">Your Profile</div>
              <div className="db-profile-row">
                <div className="db-profile-avatar">{userName.charAt(0).toUpperCase()}</div>
                <div>
      ...
      {/* Dashboard AdSense Ad - Below main content */}
      <motion.div 
        className="dashboard-ad-section"
      ...
      >
        <AdBanner 
          adSlot="REPLACE_WITH_DASHBOARD_SLOT_ID"
          style={{ 
            margin: '24px 0',
            borderRadius: '8px',
            overflow: 'hidden'
